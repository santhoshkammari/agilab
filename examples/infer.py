...
# agent("grpo trainer code example from official documentation transformers ")
agent("virat vs rohit icc stats compare, first get virats precise from wikipedia , then rohit and tehn compare")

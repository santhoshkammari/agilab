import { g as de } from "./chunk-E2GYISFI-yRsAzRk-.js";
import { _ as d, E as at, d as R, e as ge, l as m, y as ue, A as pe, c as z, ai as fe, R as xe, S as ye, O as be, aj as Z, ak as Yt, al as we, u as tt, k as me, am as Le, an as xt, ao as Se, i as Tt } from "./mermaid.core-VNpJvtL_.js";
import { c as ve } from "./clone-n-t7Ge-3.js";
import { G as Ee } from "./graph-CPfNohoA.js";
import { c as _e } from "./channel-BzZ0REy3.js";
var yt = function() {
  var e = /* @__PURE__ */ d(function(N, x, g, u) {
    for (g = g || {}, u = N.length; u--; g[N[u]] = x) ;
    return g;
  }, "o"), t = [1, 7], r = [1, 13], n = [1, 14], i = [1, 15], a = [1, 19], s = [1, 16], l = [1, 17], o = [1, 18], f = [8, 30], h = [8, 21, 28, 29, 30, 31, 32, 40, 44, 47], y = [1, 23], b = [1, 24], L = [8, 15, 16, 21, 28, 29, 30, 31, 32, 40, 44, 47], E = [8, 15, 16, 21, 27, 28, 29, 30, 31, 32, 40, 44, 47], D = [1, 49], v = {
...
var ke = yt, V = /* @__PURE__ */ new Map(), St = [], bt = /* @__PURE__ */ new Map(), Ct = "color", Bt = "fill", De = "bgFill", Ht = ",", Ne = z(), ct = /* @__PURE__ */ new Map(), Te = /* @__PURE__ */ d((e) => me.sanitizeText(e, Ne), "sanitizeText"), Ce = /* @__PURE__ */ d(function(e, t = "") {
  ...
  m.debug("Clear called"), ue(), rt = { id: "root", type: "composite", children: [], columns: -1 }, V = /* @__PURE__ */ new Map([["root", rt]]), vt = [], ct = /* @__PURE__ */ new Map(), St = [], bt = /* @__PURE__ */ new Map();
}, "clear");
function Xt(e) {
...
`, "getStyles"), Ve = je, Ge = /* @__PURE__ */ d((e, t, r, n) => {
  ...
  m.trace("Making markers for ", r), e.append("defs").append("marker").attr("id", r + "_" + t + "-extensionStart").attr("class", "marker extension " + t).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 1,7 L18,13 V 1 Z"), e.append("defs").append("marker").attr("id", r + "_" + t + "-extensionEnd").attr("class", "marker extension " + t).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 1,1 V 13 L18,7 Z");
...
function ot(e, t, r = 0, n = 0) {
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    for (const S of e.children)
      ot(S, t);
    const T = nr(e);
    i = T.width, a = T.height, m.debug("setBlockSizes abc95 maxWidth of", e.id, ":s children is ", i, a);
    for (const S of e.children)
      S.size && (m.debug(
        `abc95 Setting size of children of ${e.id} id=${S.id} ${i} ${a} ${JSON.stringify(S.size)}`
      ), S.size.width = i * (S.widthInColumns ?? 1) + I * ((S.widthInColumns ?? 1) - 1), S.size.height = a, S.size.x = 0, S.size.y = 0, m.debug(
    ...
    if (u < r) {
      ...
      m.debug("Size indata abc88", e.id, "childWidth", S, "maxWidth", i), m.debug("Size indata abc88", e.id, "childHeight", c, "maxHeight", a), m.debug("Size indata abc88 xSize", x, "padding", I);
    ...
    if (m.debug(
      ...
      if (S > 0) {
        const c = (u - S * I - I) / S;
        m.debug("abc95 (growing to fit) width", e.id, u, (b = e.size) == null ? void 0 : b.width, c);
        for (const _ of e.children)
...
d(ot, "setBlockSizes");
function Et(e, t) {
  var n, i, a, s, l, o, f, h, y, b, L, E, D, v, T, k, N;
  m.debug(
  ...
  e.children.length > 0) {
    ...
    for (const c of e.children) {
      ...
      if (X != S && (S = X, w = (b = e == null ? void 0 : e.size) != null && b.x ? ((L = e == null ? void 0 : e.size) == null ? void 0 : L.x) + (-((E = e == null ? void 0 : e.size) == null ? void 0 : E.width) / 2 || 0) : -I, m.debug("New row in layout for block", e.id, " and child ", c.id, S)), m.debug(
        ...
        ), w = c.size.x + W, c.size.y = _.size.y - _.size.height / 2 + X * (A + I) + A / 2 + I, m.debug(
      ...
      c.children && Et(c), u += (c == null ? void 0 : c.widthInColumns) ?? 1, m.debug("abc88 columnsPos", c, u);
    }
  }
  m.debug(
...
function Gt(e) {
  ...
  if (!t)
    return;
  ot(t, e, 0, 0), Et(t), m.debug("getBlocks", JSON.stringify(t, null, 2));
...
var dr = /* @__PURE__ */ d((e, t) => {
  m.debug("Moving label abc88 ", e.id, e.label, mt[e.id], t);
  ...
  if (Math.abs(i - t.y) * s > Math.abs(n - t.x) * o) {
    ...
    return l === 0 && (b.x = t.x, b.y = t.y), h === 0 && (b.x = t.x), f === 0 && (b.y = t.y), m.debug(`abc89 topp/bott calc, Q ${f}, q ${y}, R ${h}, r ${l}`, b), b;
  } else {
    r.x < t.x ? l = t.x - s - n : l = n - s - t.x;
    let y = f * l / h, b = r.x < t.x ? r.x + h - l : r.x - h + l, L = r.y < t.y ? r.y + y : r.y - y;
    return m.debug(`sides calc abc89, Q ${f}, q ${y}, R ${h}, r ${l}`, { _x: b, _y: L }), l === 0 && (b = t.x, L = t.y), h === 0 && (b = t.x), f === 0 && (L = t.y), { x: b, y: L };
  }
...
var br = $t;
function te(e, t, r, n) {
  var i, a, s, l, o, f, h, y, b, L, E, D, v, T, k;
  if (i = t.y - e.y, s = e.x - t.x, o = t.x * e.y - e.x * t.y, b = i * r.x + s * r.y + o, L = i * n.x + s * n.y + o, !(b !== 0 && L !== 0 && Lt(b, L)) && (a = n.y - r.y, l = r.x - n.x, f = n.x * r.y - r.x * n.y, h = a * e.x + l * e.y + f, y = a * t.x + l * t.y + f, !(h !== 0 && y !== 0 && Lt(h, y)) && (E = i * l - a * s, E !== 0)))
...
var Lr = /* @__PURE__ */ d((e, t) => {
  ...
  return s ? o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")") : o.attr("transform", "translate(0, " + -b.height / 2 + ")"), t.centerLabel && o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")"), o.insert("rect", ":first-child"), { shapeSvg: l, bbox: b, halfPadding: L, label: o };
...
var vr = /* @__PURE__ */ d(async (e, t) => {
  ...
  return o.attr("style", t.style), B(t, o), t.intersect = function(f) {
    return m.warn("Intersect called"), C.polygon(t, l, f);
  }, r;
  ...
  return B(t, f), t.intersect = function(h) {
    ...
    if (a != 0 && (Math.abs(b) < t.width / 2 || Math.abs(b) == t.width / 2 && Math.abs(y.y - t.y) > t.height / 2 - s)) {
      let L = s * s * (1 - b * b / (a * a));
      L != 0 && (L = Math.sqrt(L)), L = s - L, h.y - t.y > 0 && (L = -L), y.y += L;
    }
    return y;
  }, r;
  ...
  if (n.attr("width", i).attr("height", a), r.attr("class", "label edgeLabel"), t.props) {
    ...
    t.props.borders && (ht(n, t.props.borders, i, a), s.delete("borders")), s.forEach((l) => {
      m.warn(`Unknown node property ${l}`);
    });
  }
...
function ht(e, t, r, n) {
  ...
  t.includes("t") ? (m.debug("add top border"), a(r)) : s(r), t.includes("r") ? (m.debug("add right border"), a(n)) : s(n), t.includes("b") ? (m.debug("add bottom border"), a(r)) : s(r), t.includes("l") ? (m.debug("add left border"), a(n)) : s(n), e.attr("stroke-dasharray", i.join(" "));
}
...
var Fr = /* @__PURE__ */ d(async (e, t) => {
  ...
  let o = "";
  typeof l == "object" ? o = l[0] : o = l, m.info("Label text abc79", o, l, typeof l == "object");
  ...
  return a.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + i).attr("width", n.width + t.padding).attr("height", n.height + t.padding), m.info("Circle main"), B(t, a), t.intersect = function(s) {
    return m.info("Circle intersect", t, n.width / 2 + i, s), C.circle(t, n.width / 2 + i, s);
  }, r;
  ...
  ), L += x.height + n, o.attr("class", "divider").attr("x1", -h / 2 - r).attr("x2", h / 2 + r).attr("y1", -y / 2 - r + i + L).attr("y2", -y / 2 - r + i + L), L += i, g.forEach((c) => {
    R(c).attr(
      "transform",
      "translate( " + -h / 2 + ", " + (-1 * y / 2 + L + i / 2) + ")"
    );
    const _ = c == null ? void 0 : c.getBBox();
    L += ((_ == null ? void 0 : _.height) ?? 0) + n;
  }), L += i, f.attr("class", "divider").attr("x1", -h / 2 - r).attr("x2", h / 2 + r).attr("y1", -y / 2 - r + i + L).attr("y2", -y / 2 - r + i + L), L += i, u.forEach((c) => {
    R(c).attr(
      "transform",
...
function kt(e, t, r = !1) {
  ...
  return {
    ...
    intersect: void 0,
    type: n.type,
    padding: l ?? ((E = (L = at()) == null ? void 0 : L.block) == null ? void 0 : E.padding) ?? 0
  };
}
...
var Vr = /* @__PURE__ */ d(function(e, t) {
  ...
  const y = s.getBlocks(), b = s.getBlocksFlat(), L = s.getEdges(), E = f.insert("g").attr("class", "block");
  await ie(E, y, s);
  const D = Gt(s);
  if (await ne(E, y, s), await le(E, L, b, s, t), D) {
    const v = D, T = Math.max(1, Math.round(0.125 * (v.width / v.height))), k = v.height + T + 10, N = v.width + 10, { useMaxWidth: x } = a;
    ge(f, k, N, !!x), m.debug("Here Bounds", D, v), f.attr(
      "viewBox",

import { _ as nt, g as Je, s as Qe, a as Ke, b as je, q as _e, p as tr, H as er, V as rr, D as ir, E as ar, F as nr, y as or, l as be, ak as Te, c as Ne, aH as ye, d as sr, aI as lr, aJ as hr } from "./mermaid.core-VNpJvtL_.js";
import { p as fr } from "./chunk-353BL4L5-B_ooTo1A.js";
import { I as cr } from "./chunk-AACKK3MU-D4hgWLdR.js";
import { p as gr } from "./treemap-75Q7IDZK-CIjl8KhU.js";
import { c as Pe } from "./cytoscape.esm-CphbmbIK.js";
import { c as Le, g as ur } from "./Index-BG2POTv1.js";
...
`, "getStyles"), Vr = Wr, ae = /* @__PURE__ */ nt((C) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${C}</g>`, "wrapIcon"), oe = {
    ...
    X.nodes().map(async (a) => {
      ...
      if (r.type === "group") {
        ...
        if (r.icon) {
          const c = t.append("g");
          c.html(
            `<g>${await ye(r.icon, { height: G, width: G, fallbackPrefix: oe.prefix })}</g>`
          ), c.attr(
            "transform",
  ...
  for (const G of A) {
    ...
    if (G.icon)
      h.html(
        `<g>${await ye(G.icon, { height: g, width: g, fallbackPrefix: oe.prefix })}</g>`
      );
    else if (G.iconText) {
      h.html(
